...
import 'd_market_services_home_model.dart';
export 'd_market_services_home_model.dart';

class DMarketServicesHomeWidget extends StatefulWidget {
  const DMarketServicesHomeWidget({Key? key}) : super(key: key);

  @override
  _DMarketServicesHomeWidgetState createState() =>
      _DMarketServicesHomeWidgetState();
}

class _DMarketServicesHomeWidgetState extends State<DMarketServicesHomeWidget> {
  late DMarketServicesHomeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DMarketServicesHomeModel());
