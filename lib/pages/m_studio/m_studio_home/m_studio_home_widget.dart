...
import 'm_studio_home_model.dart';
export 'm_studio_home_model.dart';

class MStudioHomeWidget extends StatefulWidget {
  const MStudioHomeWidget({
    Key? key,
    this.userProfile,
  }) : super(key: key);
  ...
  @override
  _MStudioHomeWidgetState createState() => _MStudioHomeWidgetState();
}

class _MStudioHomeWidgetState extends State<MStudioHomeWidget> {
  late MStudioHomeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MStudioHomeModel());
        ...
        children: [
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                wrapWithModel(
                  model: _model.studioHomeAppBarModel,
                  updateCallback: () => setState(() {}),
                  child: StudioHomeAppBarWidget(),
                ),
                Stack(
                  children: [
                    Column(
                                                  ...
                                                  Container(
                                                    ...
                                                    decoration: BoxDecoration(
                                                      image: DecorationImage(
                                                        fit: BoxFit.cover,
                                                        image: Image.network(
                                                          'https://picsum.photos/seed/8791/1000',
                                                        ).image,
                                                      ),
                                                      boxShadow: [
                                                        BoxShadow(
